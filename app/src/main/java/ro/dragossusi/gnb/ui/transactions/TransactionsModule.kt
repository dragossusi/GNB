 ...
 *
 */
@Module(includes = [TransactionsViewModel.Module::class])
class TransactionsModule {

    @Provides
    fun adapter(activity: TransactionsActivity):TransactionsAdapter = TransactionsAdapter(activity)

    @Provides
    fun activity(activity: TransactionsActivity):DaggerAppCompatActivity =activity
